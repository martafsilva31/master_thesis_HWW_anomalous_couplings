...
Includes the CP-odd and CP-even operator(oHW and oHWtilde), with morphing done up to 2nd order (SM + SM-EFT interference term + EFT^2 term).
...
def setup_madminer(main_dir,plot_dir):
    """
    Sets up the MadMiner instance for WH signal, with the CP-odd and CP-even operator (oHWtil and oHW), and morphing up to 2nd order.
    """ 
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Creates MadMiner parameter and morphing setup file for a WH signal,  with the CP-odd and CP-even operators (oHWtilde and oHW), \
