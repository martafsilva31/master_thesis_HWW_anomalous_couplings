...
plt.plot(grid_points,rescaled_log_r, label = "test_split = 1.0", color = 'teal')
...
plt.plot(grid_points,rescaled_log_r, label = "test_split = 0.5", color = 'indigo', ls ='--')
...
plt.plot(grid_points,rescaled_log_r, label = "test_split = 0.2", color = 'mediumvioletred', ls ='-.')
...
plt.savefig("ql_cos_delta_plus_different_test_splits_fit.pdf", dpi=600,bbox_inches='tight')
